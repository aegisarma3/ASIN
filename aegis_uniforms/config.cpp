...
//   ╚═══╝  ╚══════╝╚══════╝   ╚═╝   ╚══════╝
	...
	// 	picture = "\aegis_uniforms\ui\aegis_icon.paa";
	// 	hiddenSelections[] = {"camo","insignia"};
	// 	hiddenSelectionsTextures[] = {"\aegis_uniforms\data\vests\V_aegis_carrier_lite_blk.paa"};
  ...
  class V_aegis_carrier_rig_wood: ItemCore
  {
	...
	// 	hiddenSelections[] = {"camo"};
	// 	hiddenSelectionsTextures[] = {"\aegis_uniforms\data\cct_helmet_pt.paa"};
	...
	// 	hiddenSelections[] = {"camo"};
	// 	hiddenSelectionsTextures[] = {"\aegis_uniforms\data\cct_vest_pt.paa"};
